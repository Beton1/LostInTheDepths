...
class AdjointIntegrator(Integrator):
    ...
    def __init__(self: mitsuba.scalar_spectral.AdjointIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    @overload
    def render(self: mitsuba.scalar_spectral.Integrator, scene: mitsuba.scalar_spectral.Scene, sensor, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> mitsuba.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render(self: mitsuba.scalar_spectral.Integrator, scene: mitsuba.scalar_spectral.Scene, sensor: int = 0, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> mitsuba.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render_backward(self: mitsuba.scalar_spectral.AdjointIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_backward(self: mitsuba.scalar_spectral.AdjointIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor: int = 0, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_forward(self: mitsuba.scalar_spectral.AdjointIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, sensor, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    @overload
    def render_forward(self: mitsuba.scalar_spectral.AdjointIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, sensor: int = 0, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
...
class BSDF(Object):
    ...
    def eval_attribute(self: mitsuba.scalar_spectral.BSDF, name: str, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_attribute_1(self: mitsuba.scalar_spectral.BSDF, name: str, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> float:
        """
    ...
    def eval_attribute_3(self: mitsuba.scalar_spectral.BSDF, name: str, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.Color3f:
        """
    ...
    def eval_diffuse_reflectance(self: mitsuba.scalar_spectral.BSDF, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_pdf_sample(self: mitsuba.scalar_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.scalar_spectral.SurfaceInteraction3f, wo: mitsuba.Vector3f, sample1: float, sample2: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, float, mitsuba.scalar_spectral.BSDFSample3f, mitsuba.scalar_spectral.Spectrum]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    def has_attribute(self: mitsuba.scalar_spectral.BSDF, name: str, active: bool = True) -> bool:
        """
...
class ContinuousDistribution:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ContinuousDistribution, range: mitsuba.Vector2f, pdf: mitsuba.ArrayXf) -> None:
        """
        Initialize from a given density function on the interval ``range``
        """
        ...

    def cdf(self: mitsuba.scalar_spectral.ContinuousDistribution) -> mitsuba.ArrayXf:
        """
    ...
    def max(self: mitsuba.scalar_spectral.ContinuousDistribution) -> float: ...
    ...
    def pdf(self: mitsuba.scalar_spectral.ContinuousDistribution) -> mitsuba.ArrayXf:
        """
...
class CppADIntegrator(SamplingIntegrator):
    ...
    @overload
    def render_backward(self: mitsuba.scalar_spectral.SamplingIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_backward(self: mitsuba.scalar_spectral.SamplingIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor: int = 0, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_forward(self: mitsuba.scalar_spectral.SamplingIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, sensor, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    @overload
    def render_forward(self: mitsuba.scalar_spectral.SamplingIntegrator, scene: mitsuba.scalar_spectral.Scene, params: object, sensor: int = 0, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
...
class DiscreteDistribution:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DiscreteDistribution, pmf: mitsuba.ArrayXf) -> None:
        """
        Initialize from a given probability mass function
        """
        ...

    def cdf(self: mitsuba.scalar_spectral.DiscreteDistribution) -> mitsuba.ArrayXf:
        """
    ...
    def pmf(self: mitsuba.scalar_spectral.DiscreteDistribution) -> mitsuba.ArrayXf:
        """
...
class Emitter(Endpoint):
    ...
    def pdf_position(self: mitsuba.scalar_spectral.Endpoint, ps, active: bool = True) -> float:
        """
    ...
    def sample_position(self: mitsuba.scalar_spectral.Endpoint, ref: float, ds: mitsuba.Point2f, active: bool = True):
        """
    ...
    def sampling_weight(self: mitsuba.scalar_spectral.Emitter) -> float:
        """
...
class Film(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.Film, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def base_channels_count(self: mitsuba.scalar_spectral.Film) -> int:
        """
    ...
    def clear(self: mitsuba.scalar_spectral.Film) -> None:
        """
    ...
    def develop(self: mitsuba.scalar_spectral.Film, raw: bool = False) -> mitsuba.TensorXf:
        """
...
class Hierarchical2D0:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D0, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(0)] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> float:
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
...
class Hierarchical2D1:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D1, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(1)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D2:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D2, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(2)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D3:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D3, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(3)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class ImageBlock(Object):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ImageBlock, size: mitsuba.Vector2u, offset: mitsuba.Point2i, channel_count: int, rfilter: mitsuba.scalar_spectral.ReconstructionFilter = None, border: bool = True, normalize: bool = False, coalesce: bool = False, compensate: bool = False, warn_negative: bool = True, warn_invalid: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ImageBlock, tensor: mitsuba.TensorXf, offset: mitsuba.Point2i = [0, 0], rfilter: mitsuba.scalar_spectral.ReconstructionFilter = None, border: bool = True, normalize: bool = False, coalesce: bool = False, compensate: bool = False, warn_negative: bool = True, warn_invalid: bool = True) -> None: ...
    ptr = ...
    ...
    def compensate(self: mitsuba.scalar_spectral.ImageBlock) -> bool:
        """
    ...
    def set_compensate(self: mitsuba.scalar_spectral.ImageBlock, arg0: bool) -> None:
        """
        Use Kahan-style error-compensated floating point accumulation?
        """
        ...
    ...
    def tensor(self: mitsuba.scalar_spectral.ImageBlock) -> mitsuba.TensorXf:
        """
...
class IrregularContinuousDistribution:
    ...
    *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, nodes: mitsuba.ArrayXf, pdf: mitsuba.ArrayXf) -> None:
        """
    ...
    def cdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> mitsuba.ArrayXf:
        """
        Return the unnormalized discrete cumulative distribution function over
        intervals
        """
    ...
    def max(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> float: ...
    def nodes(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> mitsuba.ArrayXf:
        """
    ...
    def pdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> mitsuba.ArrayXf:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> mitsuba.Array2f:
        """
        Return the range of the distribution
        """
        ...
...
class MarginalContinuous2D0:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D0, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(0)] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D1:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D1, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(1)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D2:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D2, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(2)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D3:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D3, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(3)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D0:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(0)] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D1:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(1)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D2:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(2)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D3:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(3)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Medium(Object):
    ...
    def transmittance_eval_pdf(self: mitsuba.scalar_spectral.Medium, mi, si, active: bool) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
...
class Mesh(Shape):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Mesh, name: str, vertex_count: int, face_count: int, props: mitsuba.Properties = Properties(), has_vertex_normals: bool = False, has_vertex_texcoords: bool = False) -> None:
        """
    ...
    def compute_surface_interaction(self: mitsuba.scalar_spectral.Shape, ray: mitsuba.scalar_spectral.Ray3f, pi, ray_flags: int = 14, active: bool = True):
        """
    ...
    def differential_motion(self: mitsuba.scalar_spectral.Shape, si, active: bool = True) -> mitsuba.Point3f:
        """
    ...
    def eval_parameterization(self: mitsuba.scalar_spectral.Shape, uv: mitsuba.Point2f, ray_flags: int = 14, active: bool = True):
        """
    ...
    def face_indices(self: mitsuba.scalar_spectral.Mesh, index: int, active: bool = True) -> mitsuba.Array3u:
        """
        Returns the vertex indices associated with triangle ``index``
        """
        ...

    def has_attribute(self: mitsuba.scalar_spectral.Shape, name: str, active: bool = True) -> bool:
        """
    ...
    def invert_silhouette_sample(self: mitsuba.scalar_spectral.Shape, ss, active: bool = True) -> mitsuba.Point3f:
        """
    ...
    def precompute_silhouette(self: mitsuba.scalar_spectral.Shape, viewpoint: mitsuba.Point3f) -> Tuple[mitsuba.ArrayXu, mitsuba.ArrayXf]:
        """
    ...
    def primitive_silhouette_projection(self: mitsuba.scalar_spectral.Shape, viewpoint: mitsuba.Point3f, si, flags: int, sample: float, active: bool = True):
        """
    ...
    def ray_intersect_preliminary(self: mitsuba.scalar_spectral.Shape, ray: mitsuba.scalar_spectral.Ray3f, prim_index: int = 0, active: bool = True):
        """
    ...
    def sample_precomputed_silhouette(self: mitsuba.scalar_spectral.Shape, viewpoint: mitsuba.Point3f, sample1: int, sample2: float, active: bool = True):
        """
    ...
    def sample_silhouette(self: mitsuba.scalar_spectral.Shape, sample: mitsuba.Point3f, flags: int, active: bool = True):
        """
    ...
    def shape_type(self: mitsuba.scalar_spectral.Shape) -> int:
        """
        Returns the shape type ShapeType of this shape
        """
        ...

    def silhouette_discontinuity_types(self: mitsuba.scalar_spectral.Shape) -> int:
        """
        //! @{ \name Silhouette sampling routines and other utilities
        """
        ...

    def silhouette_sampling_weight(self: mitsuba.scalar_spectral.Shape) -> float:
        """
    ...
    @overload
    def write_ply(self: mitsuba.scalar_spectral.Mesh, stream: mitsuba.Stream) -> None:
        """
...
class OptixDenoiser(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.OptixDenoiser, input_size: mitsuba.Vector2u, albedo: bool = False, normals: bool = False, temporal: bool = False) -> None:
        """
    ...
    @overload
    def __call__(self: mitsuba.scalar_spectral.OptixDenoiser, noisy: mitsuba.TensorXf, denoise_alpha: bool = True, albedo: mitsuba.TensorXf = [], normals: mitsuba.TensorXf = [], to_sensor: object = None, flow: mitsuba.TensorXf = [], previous_denoised: mitsuba.TensorXf = []) -> mitsuba.TensorXf:
        """
    ...
    @overload
    def __call__(self: mitsuba.scalar_spectral.OptixDenoiser, noisy: mitsuba.Bitmap, denoise_alpha: bool = True, albedo_ch: str = '', normals_ch: str = '', to_sensor: object = None, flow_ch: str = '', previous_denoised_ch: str = '', noisy_ch: str = '<root>') -> mitsuba.Bitmap:
        """
...
class PhaseFunction(Object):
    ...
    def eval_pdf(self: mitsuba.scalar_spectral.PhaseFunction, ctx: mitsuba.scalar_spectral.PhaseFunctionContext, mi: mitsuba.scalar_spectral.MediumInteraction3f, wo: mitsuba.Vector3f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, float]:
        """
    ...
    def sample(self: mitsuba.scalar_spectral.PhaseFunction, ctx: mitsuba.scalar_spectral.PhaseFunctionContext, mi: mitsuba.scalar_spectral.MediumInteraction3f, sample1: float, sample2: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.Vector3f, mitsuba.scalar_spectral.Spectrum, float]:
        """
...
class PhaseFunctionContext:
    def __init__(self: mitsuba.scalar_spectral.PhaseFunctionContext, sampler, mode: mitsuba.TransportMode = TransportMode.Radiance) -> None:
        """
        //! @}
        """
        ...
...
class ProjectiveCamera(Sensor):
    ...
    def eval(self: mitsuba.scalar_spectral.Sensor, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.scalar_spectral.Sensor, it: mitsuba.scalar_spectral.Interaction3f, ds: mitsuba.scalar_spectral.DirectionSample3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def pdf_direction(self: mitsuba.scalar_spectral.Sensor, it: mitsuba.scalar_spectral.Interaction3f, ds: mitsuba.scalar_spectral.DirectionSample3f, active: bool = True) -> float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.scalar_spectral.Sensor, ps: mitsuba.scalar_spectral.PositionSample3f, active: bool = True) -> float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.scalar_spectral.Sensor, it: mitsuba.scalar_spectral.Interaction3f, sample: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.DirectionSample3f, mitsuba.scalar_spectral.Spectrum]:
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.scalar_spectral.Sensor, time: float, sample: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.PositionSample3f, float]:
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.scalar_spectral.Sensor, time: float, sample1: float, sample2: mitsuba.Point2f, sample3: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Ray3f, mitsuba.scalar_spectral.Spectrum]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_wavelengths(self: mitsuba.scalar_spectral.Sensor, si: mitsuba.scalar_spectral.SurfaceInteraction3f, sample: float, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def shape(self: mitsuba.scalar_spectral.Sensor) -> mitsuba.scalar_spectral.Shape:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...
...
class Scene(Object):
    ...
    * Sampling directions approximately proportional to the direct
    ...
    def invert_silhouette_sample(self: mitsuba.scalar_spectral.Scene, ss, active: bool = True) -> mitsuba.Point3f:
        """
        Map a silhouette segment to a point in boundary sample space
    ...
    def sample_emitter_ray(self: mitsuba.scalar_spectral.Scene, time: float, sample1: float, sample2: mitsuba.Point2f, sample3: mitsuba.Point2f, active: bool):
        """
    ...
    def sample_silhouette(self: mitsuba.scalar_spectral.Scene, sample: mitsuba.Point3f, flags: int, active: bool = True):
        """
        Map a point sample in boundary sample space to a silhouette segment
    ...
    def sensors(self: mitsuba.scalar_spectral.Scene) -> list:
        """
        Return the list of sensors
        """
        ...

    def sensors_dr(self: mitsuba.scalar_spectral.Scene):
        """
    ...
    def silhouette_shapes(self: mitsuba.scalar_spectral.Scene) -> list:
        """
...
class SilhouetteSample3f(PositionSample3f):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.SilhouetteSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.SilhouetteSample3f, other: mitsuba.scalar_spectral.SilhouetteSample3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.scalar_spectral.SilhouetteSample3f, arg0: mitsuba.scalar_spectral.SilhouetteSample3f) -> None: ...
    def is_valid(self: mitsuba.scalar_spectral.SilhouetteSample3f) -> bool:
        """
        Is the current boundary segment valid=
        """
        ...

    def spawn_ray(self: mitsuba.scalar_spectral.SilhouetteSample3f) -> mitsuba.scalar_spectral.Ray3f:
        """
...
class Texture1f64:
    ...
    def eval_fetch(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
...
class Texture1f:
    ...
    def eval_fetch(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
...
class Texture2f64:
    ...
    def eval_fetch(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
...
class Texture2f:
    ...
    def eval_fetch(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
...
class Texture3f64:
    ...
    def eval_fetch(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
...
class Texture3f:
    ...
    def eval_fetch(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
...
class Volume(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.Volume, props: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def eval_6(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> Annotated[List[float], FixedSize(6)]:
        """
...
from . import scalar_spectral_mueller as mueller
...
from . import scalar_spectral_quad as quad
...
def sample_shifted(sample: float) -> mitsuba.Array4f: ...
...
from . import scalar_spectral_spline as spline

def srgb_model_eval(arg0: mitsuba.Array3f, arg1: mitsuba.scalar_spectral.Spectrum) -> mitsuba.scalar_spectral.Spectrum: ...
...
from . import scalar_spectral_warp as warp

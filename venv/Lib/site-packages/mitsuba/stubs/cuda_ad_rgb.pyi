...
class AdjointIntegrator(Integrator):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.AdjointIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    @overload
    def render(self: mitsuba.cuda_ad_rgb.Integrator, scene: mitsuba.cuda_ad_rgb.Scene, sensor, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> mitsuba.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render(self: mitsuba.cuda_ad_rgb.Integrator, scene: mitsuba.cuda_ad_rgb.Scene, sensor: int = 0, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> mitsuba.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render_backward(self: mitsuba.cuda_ad_rgb.AdjointIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, grad_in: mitsuba.TensorXf, sensor, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_backward(self: mitsuba.cuda_ad_rgb.AdjointIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, grad_in: mitsuba.TensorXf, sensor: int = 0, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_forward(self: mitsuba.cuda_ad_rgb.AdjointIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, sensor, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    @overload
    def render_forward(self: mitsuba.cuda_ad_rgb.AdjointIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, sensor: int = 0, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
...
class BSDF(Object):
    ...
    def component_count(self: mitsuba.cuda_ad_rgb.BSDF, active: mitsuba.Bool = True) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_attribute(self: mitsuba.cuda_ad_rgb.BSDF, name: str, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_attribute_1(self: mitsuba.cuda_ad_rgb.BSDF, name: str, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_attribute_3(self: mitsuba.cuda_ad_rgb.BSDF, name: str, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_diffuse_reflectance(self: mitsuba.cuda_ad_rgb.BSDF, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_null_transmission(self: mitsuba.cuda_ad_rgb.BSDF, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float]:
        """
    ...
    def eval_pdf_sample(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float, mitsuba.cuda_ad_rgb.BSDFSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.BSDF, index: int, active: mitsuba.Bool = True) -> int:
        """
    ...
    def has_attribute(self: mitsuba.cuda_ad_rgb.BSDF, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
    ...
    def pdf(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.BSDFSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
...
class BSDFPtr:
    ...
    def eval(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate the BSDF f(wi, wo) or its adjoint version f^{*}(wi, wo) and
        multiply by the cosine foreshortening term.
    ...
    def eval_attribute(self: mitsuba.cuda_ad_rgb.BSDFPtr, name: str, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate a specific BSDF attribute at the given surface interaction.
    ...
    def eval_attribute_1(self: mitsuba.cuda_ad_rgb.BSDFPtr, name: str, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Monochromatic evaluation of a BSDF attribute at the given surface
        interaction
    ...
    def eval_attribute_3(self: mitsuba.cuda_ad_rgb.BSDFPtr, name: str, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Trichromatic evaluation of a BSDF attribute at the given surface
        interaction
    ...
    def eval_diffuse_reflectance(self: mitsuba.cuda_ad_rgb.BSDFPtr, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate the diffuse reflectance
    ...
    def eval_null_transmission(self: mitsuba.cuda_ad_rgb.BSDFPtr, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate un-scattered transmission component of the BSDF
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    def eval_pdf_sample(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float, mitsuba.cuda_ad_rgb.BSDFSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    def flags(self: mitsuba.cuda_ad_rgb.BSDFPtr) -> mitsuba.UInt:
        """
        Flags for all components combined.
        """
        ...

    def has_attribute(self: mitsuba.cuda_ad_rgb.BSDFPtr, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Returns whether this BSDF contains the specified attribute.
    ...
    def needs_differentials(self: mitsuba.cuda_ad_rgb.BSDFPtr) -> mitsuba.Bool:
        """
        Does the implementation require access to texture-space differentials?
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Compute the probability per unit solid angle of sampling a given
        direction
    ...
    def sample(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.BSDFSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample the BSDF model
...
class Bool:
    @overload
    def __init__(self: mitsuba.Bool, arg0: bool) -> None: ...
    @overload
    def __init__(self: mitsuba.Bool, arg0: mitsuba.Bool) -> None: ...
    @overload
    def __init__(self: mitsuba.Bool, arg0: mitsuba.Bool) -> None: ...
    @overload
    def __init__(self: mitsuba.Bool, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.Bool, arg0: mitsuba.Bool) -> None: ...
    ...
...
class BoundingBox2f:
    ...
    def collapsed(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.Bool:
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox2f, p: mitsuba.cuda_ad_rgb.Point2f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox2f, bbox: mitsuba.cuda_ad_rgb.BoundingBox2f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.Float:
        """
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and ``bbox``.
        """
    ...
    def major_axis(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.UInt:
        """
        Return the dimension index with the index associated side length
        """
        ...

    def minor_axis(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.UInt:
        """
        Return the dimension index with the shortest associated side length
        """
        ...

    def overlaps(self: mitsuba.cuda_ad_rgb.BoundingBox2f, bbox: mitsuba.cuda_ad_rgb.BoundingBox2f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.Float:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
    ...
    def surface_area(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.Float:
        """
        Calculate the 2-dimensional surface area of a 3D bounding box
        """
        ...

    def valid(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.Bool:
        """
    ...
    def volume(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.Float:
        """
...
class BoundingBox3f:
    ...
    def collapsed(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.Bool:
        """
        Check whether this bounding box has collapsed to a point, line, or
        plane
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox3f, p: mitsuba.cuda_ad_rgb.Point3f, strict: bool = False) -> mitsuba.Bool:
        """
        Check whether a point lies *on* or *inside* the bounding box
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox3f, bbox: mitsuba.cuda_ad_rgb.BoundingBox3f, strict: bool = False) -> mitsuba.Bool:
        """
        Check whether a specified bounding box lies *on* or *within* the
        current bounding box
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and the point ``p``.
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and ``bbox``.
        """
    ...
    def major_axis(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.UInt:
        """
        Return the dimension index with the index associated side length
        """
        ...

    def minor_axis(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.UInt:
        """
        Return the dimension index with the shortest associated side length
        """
        ...

    def overlaps(self: mitsuba.cuda_ad_rgb.BoundingBox3f, bbox: mitsuba.cuda_ad_rgb.BoundingBox3f, strict: bool = False) -> mitsuba.Bool:
        """
        Check two axis-aligned bounding boxes for possible overlap.
    ...
    def ray_intersect(self: mitsuba.cuda_ad_rgb.BoundingBox3f, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
        bounding box and the point ``p``.
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
        bounding box and ``bbox``.
        """
    ...
    def surface_area(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the 2-dimensional surface area of a 3D bounding box
        """
        ...

    def valid(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.Bool:
        """
        Check whether this is a valid bounding box
    ...
    def volume(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the n-dimensional volume of the bounding box
        """
        ...
...
class BoundingSphere3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, arg0: mitsuba.cuda_ad_rgb.Point3f, arg1: mitsuba.Float) -> None:
        """
    ...
    def contains(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, p: mitsuba.cuda_ad_rgb.Point3f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    def empty(self: mitsuba.cuda_ad_rgb.BoundingSphere3f) -> mitsuba.Bool:
        """
    ...
    def ray_intersect(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
        Check if a ray intersects a bounding box
        """
        ...
...
class ChainTransform3d(Transform3d):
    ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform3d) -> mitsuba.Bool:
        """
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform3d, angle: mitsuba.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform3d:
        """
...
class ChainTransform3f(Transform3f):
    ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform3f) -> mitsuba.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform3f, angle: mitsuba.Float) -> mitsuba.cuda_ad_rgb.ChainTransform3f:
        """
        Create a rotation transformation in 2D. The angle is specified in
        degrees
        """
...
class ChainTransform4d(Transform4d):
    ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform4d) -> mitsuba.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def orthographic(self: mitsuba.cuda_ad_rgb.ChainTransform4d, near: mitsuba.Float64, far: mitsuba.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    def perspective(self: mitsuba.cuda_ad_rgb.ChainTransform4d, fov: mitsuba.Float64, near: mitsuba.Float64, far: mitsuba.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform4d, axis: mitsuba.cuda_ad_rgb.Point3d, angle: mitsuba.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
...
class ChainTransform4f(Transform4f):
    ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform4f) -> mitsuba.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def orthographic(self: mitsuba.cuda_ad_rgb.ChainTransform4f, near: mitsuba.Float, far: mitsuba.Float) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create an orthographic transformation, which maps Z to [0,1] and
        leaves the X and Y coordinates untouched.
    ...
    def perspective(self: mitsuba.cuda_ad_rgb.ChainTransform4f, fov: mitsuba.Float, near: mitsuba.Float, far: mitsuba.Float) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a perspective transformation. (Maps [near, far] to [0, 1])
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform4f, axis: mitsuba.cuda_ad_rgb.Point3f, angle: mitsuba.Float) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a rotation transformation around an arbitrary axis in 3D. The
        angle is specified in degrees
        """
...
class ContinuousDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, range: mitsuba.Vector2f, pdf: mitsuba.Float) -> None:
        """
        Initialize from a given density function on the interval ``range``
        """
        ...

    def cdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> mitsuba.Float:
        """
    ...
    def eval_cdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_pdf_normalized(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def integral(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> mitsuba.Float:
        """
    ...
    def max(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> float: ...
    def normalization(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> mitsuba.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample_pdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.Float, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
...
class CppADIntegrator(SamplingIntegrator):
    ...
    @overload
    def render_backward(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, grad_in: mitsuba.TensorXf, sensor, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_backward(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, grad_in: mitsuba.TensorXf, sensor: int = 0, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_forward(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, sensor, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    @overload
    def render_forward(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, params: object, sensor: int = 0, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    def sample(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, sampler, ray: mitsuba.cuda_ad_rgb.RayDifferential3f, medium: mitsuba.cuda_ad_rgb.Medium = None, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Bool, List[mitsuba.Float]]:
        """
...
class DirectionSample3f(PositionSample3f):
    ...
    *direct illumination strategies* importance sample the incident
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DirectionSample3f, p: mitsuba.cuda_ad_rgb.Point3f, n: mitsuba.cuda_ad_rgb.Normal3f, uv: mitsuba.cuda_ad_rgb.Point2f, time: mitsuba.Float, pdf: mitsuba.Float, delta: mitsuba.Bool, d: mitsuba.cuda_ad_rgb.Vector3f, dist: mitsuba.Float, emitter: mitsuba.cuda_ad_rgb.EmitterPtr) -> None:
        """
...
class DiscreteDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, pmf: mitsuba.Float) -> None:
        """
        Initialize from a given probability mass function
        """
        ...

    def cdf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> mitsuba.Float:
        """
    ...
    def eval_cdf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        index ``index``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_pmf_normalized(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def normalization(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> mitsuba.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> mitsuba.Float:
        """
        Return the unnormalized probability mass function
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.UInt:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse_pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution.
    ...
    def sum(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> mitsuba.Float:
        """
...
class DiscreteDistribution2D:
    ...
    def eval(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, pos: mitsuba.cuda_ad_rgb.Point2u, active: mitsuba.Bool = True) -> mitsuba.Float: ...
    def pdf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, pos: mitsuba.cuda_ad_rgb.Point2u, active: mitsuba.Bool = True) -> mitsuba.Float: ...
    def sample(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2u, mitsuba.Float, mitsuba.cuda_ad_rgb.Point2f]: ...
    ...
...
class Emitter(Endpoint):
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Endpoint, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_direction(self: mitsuba.cuda_ad_rgb.Endpoint, it, ds, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def flags(self: mitsuba.cuda_ad_rgb.Emitter, active: mitsuba.Bool = True) -> int:
        """
        Flags for all components combined.
        """
        ...
    ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.Endpoint, it, ds, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.Endpoint, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.Endpoint, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.Endpoint, ref: mitsuba.Float, ds: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.Endpoint, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.Endpoint, si, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def sampling_weight(self: mitsuba.cuda_ad_rgb.Emitter) -> float:
        """
...
class EmitterPtr:
    ...
    def eval(self: mitsuba.cuda_ad_rgb.EmitterPtr, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.cuda_ad_rgb.EmitterPtr, it, ds, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def flags(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> mitsuba.UInt:
        """
        Flags for all components combined.
        """
        ...

    def is_environment(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> mitsuba.Bool:
        """
        Is this an environment map light emitter?
        """
        ...

    def pdf_direction(self: mitsuba.cuda_ad_rgb.EmitterPtr, it, ds, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.EmitterPtr, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.EmitterPtr, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.EmitterPtr, time: mitsuba.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.EmitterPtr, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.EmitterPtr, si, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def sampling_weight(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> mitsuba.Float:
        """
        The emitter's sampling weight.
        """
        ...
...
class Film(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Film, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def base_channels_count(self: mitsuba.cuda_ad_rgb.Film) -> int:
        """
    ...
    def clear(self: mitsuba.cuda_ad_rgb.Film) -> None:
        """
    ...
    def develop(self: mitsuba.cuda_ad_rgb.Film, raw: bool = False) -> mitsuba.TensorXf:
        """
    ...
    def prepare_sample(self: mitsuba.cuda_ad_rgb.Film, spec: mitsuba.cuda_ad_rgb.Color3f, wavelengths: mitsuba.cuda_ad_rgb.Color0f, nChannels: int, weight: mitsuba.Float = 1.0, alpha: mitsuba.Float = 1.0, active: mitsuba.Bool = True) -> List[mitsuba.Float]:
        """
...
class Float:
    @overload
    def __init__(self: mitsuba.Float, arg0: float) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.Float, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.Float, arg0: mitsuba.Float) -> None: ...
    ...

class Float64:
    @overload
    def __init__(self: mitsuba.Float64, arg0: float) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.Float64, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.Float64, arg0: mitsuba.Float64) -> None: ...
    ...
...
class Hierarchical2D0:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(0)] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
...
class Hierarchical2D1:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(1)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D2:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(2)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D3:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(3)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class ImageBlock(Object):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ImageBlock, size: mitsuba.Vector2u, offset: mitsuba.Point2i, channel_count: int, rfilter: mitsuba.cuda_ad_rgb.ReconstructionFilter = None, border: bool = False, normalize: bool = False, coalesce: bool = True, compensate: bool = False, warn_negative: bool = False, warn_invalid: bool = False) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ImageBlock, tensor: mitsuba.TensorXf, offset: mitsuba.Point2i = [0, 0], rfilter: mitsuba.cuda_ad_rgb.ReconstructionFilter = None, border: bool = False, normalize: bool = False, coalesce: bool = True, compensate: bool = False, warn_negative: bool = False, warn_invalid: bool = False) -> None: ...
    ptr = ...
    ...
    def compensate(self: mitsuba.cuda_ad_rgb.ImageBlock) -> bool:
        """
    ...
    @overload
    def put(self: mitsuba.cuda_ad_rgb.ImageBlock, pos: mitsuba.cuda_ad_rgb.Point2f, wavelengths: mitsuba.cuda_ad_rgb.Color0f, value: mitsuba.cuda_ad_rgb.Color3f, alpha: mitsuba.Float = 1.0, weight: mitsuba.Float = 1, active: mitsuba.Bool = True) -> None:
        """
    ...
    @overload
    def put(self: mitsuba.cuda_ad_rgb.ImageBlock, pos: mitsuba.cuda_ad_rgb.Point2f, values: List[mitsuba.Float], active: mitsuba.Bool = True) -> None: ...
    ...
    def read(self: mitsuba.cuda_ad_rgb.ImageBlock, pos: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def ref_count(self: mitsuba.Object) -> int:
        """
        Return the current reference count
        """
    ...
    def set_compensate(self: mitsuba.cuda_ad_rgb.ImageBlock, arg0: bool) -> None:
        """
        Use Kahan-style error-compensated floating point accumulation?
        """
        ...
    ...
    def tensor(self: mitsuba.cuda_ad_rgb.ImageBlock) -> mitsuba.TensorXf:
        """
...
class Int:
    @overload
    def __init__(self: mitsuba.Int, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.Int, arg0: mitsuba.Int) -> None: ...
    ...

class Int64:
    @overload
    def __init__(self: mitsuba.Int64, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.Int64, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.Int64, arg0: mitsuba.Int64) -> None: ...
    ...
...
class Interaction3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Interaction3f, t: mitsuba.Float, time: mitsuba.Float, wavelengths: mitsuba.cuda_ad_rgb.Color0f, p: mitsuba.cuda_ad_rgb.Point3f, n: mitsuba.cuda_ad_rgb.Normal3f = 0) -> None:
        """
        //! @}
        """
        ...
    ...
    def is_valid(self: mitsuba.cuda_ad_rgb.Interaction3f) -> mitsuba.Bool:
        """
...
class IrregularContinuousDistribution:
    ...
    *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, nodes: mitsuba.Float, pdf: mitsuba.Float) -> None:
        """
    ...
    def cdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the unnormalized discrete cumulative distribution function over
        intervals
        """
    ...
    def eval_cdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def eval_pdf_normalized(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the normalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def integral(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...
    ...
    def max(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> float: ...
    def nodes(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the nodes of the underlying discretization
        """
        ...

    def normalization(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> mitsuba.Array2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.Float, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
...
class Loop:
    def __init__(self: mitsuba.Loop, name: str, state: handle = None) -> None: ...
    def __call__(self: mitsuba.Loop, arg0: mitsuba.Bool) -> bool: ...
    def init(self: mitsuba.Loop) -> None: ...
    def put(self: mitsuba.Loop, arg0: function) -> None: ...
    def set_eval_stride(self: mitsuba.Loop, arg0: int) -> None: ...
    def set_max_iterations(self: mitsuba.Loop, arg0: int) -> None: ...
    ...
...
class MarginalContinuous2D0:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(0)] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D1:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(1)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D2:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(2)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D3:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(3)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D0:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(0)] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D1:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(1)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D2:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(2)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D3:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, data: numpy.ndarray[numpy.float32], param_values: Annotated[List[List[float]], FixedSize(3)], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Medium(Object):
    ...
    def get_majorant(self: mitsuba.cuda_ad_rgb.Medium, mi, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.cuda_ad_rgb.Medium, mi, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def intersect_aabb(self: mitsuba.cuda_ad_rgb.Medium, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
    ...
    def sample_interaction(self: mitsuba.cuda_ad_rgb.Medium, ray: mitsuba.cuda_ad_rgb.Ray3f, sample: mitsuba.Float, channel: mitsuba.UInt, active: mitsuba.Bool):
        """
    ...
    def transmittance_eval_pdf(self: mitsuba.cuda_ad_rgb.Medium, mi, si, active: mitsuba.Bool) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
...
class MediumPtr:
    ...
    def get_majorant(self: mitsuba.cuda_ad_rgb.MediumPtr, mi, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.cuda_ad_rgb.MediumPtr, mi, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Returns the medium coefficients Sigma_s, Sigma_n and Sigma_t evaluated
        at a given MediumInteraction mi
        """
    ...
    def has_spectral_extinction(self: mitsuba.cuda_ad_rgb.MediumPtr) -> mitsuba.Bool:
        """
        Returns whether this medium has a spectrally varying extinction
        """
        ...

    def intersect_aabb(self: mitsuba.cuda_ad_rgb.MediumPtr, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
        Intersects a ray with the medium's bounding box
        """
        ...

    def is_homogeneous(self: mitsuba.cuda_ad_rgb.MediumPtr) -> mitsuba.Bool:
        """
        Returns whether this medium is homogeneous
        """
        ...
    ...
    def sample_interaction(self: mitsuba.cuda_ad_rgb.MediumPtr, ray: mitsuba.cuda_ad_rgb.Ray3f, sample: mitsuba.Float, channel: mitsuba.UInt, active: mitsuba.Bool):
        """
        Sample a free-flight distance in the medium.
    ...
    def transmittance_eval_pdf(self: mitsuba.cuda_ad_rgb.MediumPtr, mi, si, active: mitsuba.Bool) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Compute the transmittance and PDF
    ...
    def use_emitter_sampling(self: mitsuba.cuda_ad_rgb.MediumPtr) -> mitsuba.Bool:
        """
        Returns whether this specific medium instance uses emitter sampling
        """
        ...
...
class Mesh(Shape):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Mesh, name: str, vertex_count: int, face_count: int, props: mitsuba.Properties = Properties(), has_vertex_normals: bool = False, has_vertex_texcoords: bool = False) -> None:
        """
    ...
    def compute_surface_interaction(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, pi, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
    ...
    def differential_motion(self: mitsuba.cuda_ad_rgb.Shape, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
    ...
    def eval_attribute(self: mitsuba.cuda_ad_rgb.Shape, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_attribute_1(self: mitsuba.cuda_ad_rgb.Shape, name: str, si, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_attribute_3(self: mitsuba.cuda_ad_rgb.Shape, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_parameterization(self: mitsuba.cuda_ad_rgb.Shape, uv: mitsuba.cuda_ad_rgb.Point2f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
    ...
    def face_indices(self: mitsuba.cuda_ad_rgb.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Array3u:
        """
        Returns the vertex indices associated with triangle ``index``
        """
        ...

    def has_attribute(self: mitsuba.cuda_ad_rgb.Shape, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
    ...
    def invert_silhouette_sample(self: mitsuba.cuda_ad_rgb.Shape, ss, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
    ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.Shape, it, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.Shape, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def precompute_silhouette(self: mitsuba.cuda_ad_rgb.Shape, viewpoint: mitsuba.Point3f) -> Tuple[mitsuba.UInt, mitsuba.Float]:
        """
    ...
    def primitive_silhouette_projection(self: mitsuba.cuda_ad_rgb.Shape, viewpoint: mitsuba.cuda_ad_rgb.Point3f, si, flags: int, sample: mitsuba.Float, active: mitsuba.Bool = True):
        """
    ...
    def ray_intersect(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, prim_index: int = 0, active: mitsuba.Bool = True):
        """
    ...
    def ray_intersect_triangle(self: mitsuba.cuda_ad_rgb.Mesh, index: mitsuba.UInt, ray: mitsuba.cuda_ad_rgb.Ray3f, active: mitsuba.Bool = True): ...
    def ray_test(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.Shape, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.Shape, time: mitsuba.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_precomputed_silhouette(self: mitsuba.cuda_ad_rgb.Shape, viewpoint: mitsuba.cuda_ad_rgb.Point3f, sample1: mitsuba.UInt, sample2: mitsuba.Float, active: mitsuba.Bool = True):
        """
    ...
    def sample_silhouette(self: mitsuba.cuda_ad_rgb.Shape, sample: mitsuba.cuda_ad_rgb.Point3f, flags: int, active: mitsuba.Bool = True):
        """
    ...
    def shape_type(self: mitsuba.cuda_ad_rgb.Shape) -> int:
        """
        Returns the shape type ShapeType of this shape
        """
        ...

    def silhouette_discontinuity_types(self: mitsuba.cuda_ad_rgb.Shape) -> int:
        """
        //! @{ \name Silhouette sampling routines and other utilities
        """
        ...

    def silhouette_sampling_weight(self: mitsuba.cuda_ad_rgb.Shape) -> float:
        """
        Return this shape's sampling weight w.r.t. all shapes in the scene
        """
        ...

    def surface_area(self: mitsuba.cuda_ad_rgb.Shape) -> mitsuba.Float:
        """
    ...
    def vertex_normal(self: mitsuba.cuda_ad_rgb.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Normal3f:
        """
        Returns the normal direction of the vertex with index ``index``
        """
        ...

    def vertex_position(self: mitsuba.cuda_ad_rgb.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Returns the world-space position of the vertex with index ``index``
        """
        ...

    def vertex_texcoord(self: mitsuba.cuda_ad_rgb.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point2f:
        """
    ...
    @overload
    def write_ply(self: mitsuba.cuda_ad_rgb.Mesh, stream: mitsuba.Stream) -> None:
        """
...
class MicrofacetDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: mitsuba.Float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: mitsuba.Float, alpha_v: mitsuba.Float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, arg0: mitsuba.Properties) -> None: ...
    def G(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, wi: mitsuba.cuda_ad_rgb.Vector3f, wo: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Float:
        """
        Smith's separable shadowing-masking approximation
        """
        ...

    def alpha(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> mitsuba.Float:
        """
        Return the roughness (isotropic case)
        """
        ...

    def alpha_u(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> mitsuba.Float:
        """
        Return the roughness along the tangent direction
        """
        ...

    def alpha_v(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> mitsuba.Float:
        """
        Return the roughness along the bitangent direction
        """
        ...

    def eval(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, m: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Float:
        """
    ...
    def pdf(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, wi: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, wi: mitsuba.cuda_ad_rgb.Vector3f, sample: mitsuba.cuda_ad_rgb.Point2f) -> Tuple[mitsuba.cuda_ad_rgb.Normal3f, mitsuba.Float]:
        """
    ...
    def sample_visible_11(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, cos_theta_i: mitsuba.Float, sample: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
        Visible normal sampling code for the alpha=1 case
        """
        ...

    def scale_alpha(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, value: mitsuba.Float) -> None:
        """
        Scale the roughness values by some constant
        """
        ...

    def smith_g1(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, v: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Float:
        """
...
class OptixDenoiser(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.OptixDenoiser, input_size: mitsuba.Vector2u, albedo: bool = False, normals: bool = False, temporal: bool = False) -> None:
        """
    ...
    @overload
    def __call__(self: mitsuba.cuda_ad_rgb.OptixDenoiser, noisy: mitsuba.TensorXf, denoise_alpha: bool = True, albedo: mitsuba.TensorXf = [], normals: mitsuba.TensorXf = [], to_sensor: object = None, flow: mitsuba.TensorXf = [], previous_denoised: mitsuba.TensorXf = []) -> mitsuba.TensorXf:
        """
    ...
    @overload
    def __call__(self: mitsuba.cuda_ad_rgb.OptixDenoiser, noisy: mitsuba.Bitmap, denoise_alpha: bool = True, albedo_ch: str = '', normals_ch: str = '', to_sensor: object = None, flow_ch: str = '', previous_denoised_ch: str = '', noisy_ch: str = '<root>') -> mitsuba.Bitmap:
        """
...
class PCG32:
    @overload
    def __init__(self: mitsuba.PCG32, size: int = 1, initstate: mitsuba.UInt64 = 9600629759793949339, initseq: mitsuba.UInt64 = 15726070495360670683) -> None: ...
    @overload
    ...
    @overload
    def next_float32(self: mitsuba.PCG32) -> mitsuba.Float: ...
    @overload
    def next_float32(self: mitsuba.PCG32, arg0: mitsuba.Bool) -> mitsuba.Float: ...
    @overload
    def next_float64(self: mitsuba.PCG32) -> mitsuba.Float64: ...
    @overload
    def next_float64(self: mitsuba.PCG32, arg0: mitsuba.Bool) -> mitsuba.Float64: ...
    @overload
    def next_uint32(self: mitsuba.PCG32) -> mitsuba.UInt: ...
    @overload
    def next_uint32(self: mitsuba.PCG32, arg0: mitsuba.Bool) -> mitsuba.UInt: ...
    def next_uint32_bounded(self: mitsuba.PCG32, bound: int, mask: mitsuba.Bool = True) -> mitsuba.UInt: ...
    @overload
    def next_uint64(self: mitsuba.PCG32) -> mitsuba.UInt64: ...
    @overload
    def next_uint64(self: mitsuba.PCG32, arg0: mitsuba.Bool) -> mitsuba.UInt64: ...
    def next_uint64_bounded(self: mitsuba.PCG32, bound: int, mask: mitsuba.Bool = True) -> mitsuba.UInt64: ...
    def seed(self: mitsuba.PCG32, size: int = 1, initstate: mitsuba.UInt64 = 9600629759793949339, initseq: mitsuba.UInt64 = 15726070495360670683) -> None: ...
    ...
...
class PhaseFunction(Object):
    ...
    def component_count(self: mitsuba.cuda_ad_rgb.PhaseFunction, active: mitsuba.Bool = True) -> int:
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.PhaseFunction, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float]:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.PhaseFunction, index: int, active: mitsuba.Bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.PhaseFunction, active: mitsuba.Bool = True) -> int:
        """
    ...
    def max_projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunction) -> mitsuba.Float:
        """
    ...
    def projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunction, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.PhaseFunction, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Vector3f, mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float]:
        """
...
class PhaseFunctionContext:
    def __init__(self: mitsuba.cuda_ad_rgb.PhaseFunctionContext, sampler, mode: mitsuba.TransportMode = TransportMode.Radiance) -> None:
        """
        //! @}
        """
        ...
...
class PhaseFunctionPtr:
    ...
    def component_count(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, active: mitsuba.Bool = True) -> mitsuba.UInt64:
        """
        Number of components this phase function is comprised of.
        """
        ...

    def eval_pdf(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float]:
        """
        Evaluates the phase function model value and PDF
    ...
    def flags(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, active: mitsuba.Bool = True) -> mitsuba.UInt:
        """
        Flags for this phase function.
        """
        ...

    def max_projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr) -> mitsuba.Float:
        """
        Return the maximum projected area of the microflake distribution
        """
        ...

    def projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Returns the microflake projected area
    ...
    def sample(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Vector3f, mitsuba.cuda_ad_rgb.Color3f, mitsuba.Float]:
        """
        Importance sample the phase function model
...
class PreliminaryIntersection3f:
    ...
    def compute_surface_interaction(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int = 14, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.SurfaceInteraction3f:
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def is_valid(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f) -> mitsuba.Bool:
        """
        Is the current interaction valid?
        """
        ...
...
class ProjectiveCamera(Sensor):
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Sensor, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.cuda_ad_rgb.Sensor, it: mitsuba.cuda_ad_rgb.Interaction3f, ds: mitsuba.cuda_ad_rgb.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def focus_distance(self: mitsuba.cuda_ad_rgb.ProjectiveCamera) -> mitsuba.Float:
        """
    ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.Sensor, it: mitsuba.cuda_ad_rgb.Interaction3f, ds: mitsuba.cuda_ad_rgb.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.Sensor, ps: mitsuba.cuda_ad_rgb.PositionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.Sensor, it: mitsuba.cuda_ad_rgb.Interaction3f, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.DirectionSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.Sensor, time: mitsuba.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.PositionSample3f, mitsuba.Float]:
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.Sensor, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    @overload
    def sample_ray_differential(self: mitsuba.cuda_ad_rgb.Sensor, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.RayDifferential3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.Sensor, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def shape(self: mitsuba.cuda_ad_rgb.Sensor) -> mitsuba.cuda_ad_rgb.Shape:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...
...
class RadicalInverse(Object):
    ...
    def eval(self: mitsuba.cuda_ad_rgb.RadicalInverse, base_index: int, index: mitsuba.UInt64) -> mitsuba.Float:
        """
...
class Ray2f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, o: mitsuba.cuda_ad_rgb.Point2f, d: mitsuba.cuda_ad_rgb.Vector2f, time: mitsuba.Float = 0.0, wavelengths: mitsuba.cuda_ad_rgb.Color0f = []) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, o: mitsuba.cuda_ad_rgb.Point2f, d: mitsuba.cuda_ad_rgb.Vector2f, maxt: mitsuba.Float, time: mitsuba.Float, wavelengths: mitsuba.cuda_ad_rgb.Color0f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, other: mitsuba.cuda_ad_rgb.Ray2f, maxt: mitsuba.Float) -> None:
        """
        Copy a ray, but change the maxt value
        """
        ...

    def __call__(self: mitsuba.cuda_ad_rgb.Ray2f, t: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Point2f:
        """
...
class Ray3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, o: mitsuba.cuda_ad_rgb.Point3f, d: mitsuba.cuda_ad_rgb.Vector3f, time: mitsuba.Float = 0.0, wavelengths: mitsuba.cuda_ad_rgb.Color0f = []) -> None:
        """
        Construct a new ray (o, d) with time
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, o: mitsuba.cuda_ad_rgb.Point3f, d: mitsuba.cuda_ad_rgb.Vector3f, maxt: mitsuba.Float, time: mitsuba.Float, wavelengths: mitsuba.cuda_ad_rgb.Color0f) -> None:
        """
        Construct a new ray (o, d) with bounds
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, other: mitsuba.cuda_ad_rgb.Ray3f, maxt: mitsuba.Float) -> None:
        """
        Copy a ray, but change the maxt value
        """
        ...

    def __call__(self: mitsuba.cuda_ad_rgb.Ray3f, t: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Return the position of a point along the ray
        """
        ...
...
class RayDifferential3f(Ray3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.RayDifferential3f, o: mitsuba.cuda_ad_rgb.Point3f, d: mitsuba.cuda_ad_rgb.Vector3f, time: mitsuba.Float = 0.0, wavelengths: mitsuba.cuda_ad_rgb.Color0f = []) -> None:
        """
    ...
    def scale_differential(self: mitsuba.cuda_ad_rgb.RayDifferential3f, amount: mitsuba.Float) -> None: ...
    ...
...
class ReconstructionFilter(Object):
    ...
    def eval(self: mitsuba.cuda_ad_rgb.ReconstructionFilter, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the filter function
        """
        ...

    def eval_discretized(self: mitsuba.cuda_ad_rgb.ReconstructionFilter, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate a discretized version of the filter (generally faster than
        'eval')
        """
...
class Sampler(Object):
    ...
    def loop_put(self: mitsuba.cuda_ad_rgb.Sampler, loop: mitsuba.LoopBase) -> None:
        """
        Register internal state of this sampler with a symbolic loop
        """
        ...

    def next_1d(self: mitsuba.cuda_ad_rgb.Sampler, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Retrieve the next component value from the current sample
        """
        ...

    def next_2d(self: mitsuba.cuda_ad_rgb.Sampler, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point2f:
        """
...
class Scene(Object):
    ...
    * Sampling directions approximately proportional to the direct
    ...
    def eval_emitter_direction(self: mitsuba.cuda_ad_rgb.Scene, ref, ds, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def invert_silhouette_sample(self: mitsuba.cuda_ad_rgb.Scene, ss, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Map a silhouette segment to a point in boundary sample space
    ...
    def pdf_emitter(self: mitsuba.cuda_ad_rgb.Scene, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def pdf_emitter_direction(self: mitsuba.cuda_ad_rgb.Scene, ref, ds, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, active: mitsuba.Bool = True):
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int, coherent: mitsuba.Bool, active: mitsuba.Bool = True):
        """
        Intersect a ray with the shapes comprising the scene and return a
        detailed data structure describing the intersection, if one is found
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, coherent: mitsuba.Bool = False, active: mitsuba.Bool = True):
        """
    ...
    @overload
    def ray_test(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
    ...
    @overload
    def ray_test(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, coherent: mitsuba.Bool, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
        boolean specifying whether or not an intersection was found.
    ...
    def sample_emitter(self: mitsuba.cuda_ad_rgb.Scene, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float, mitsuba.Float]:
        """
    ...
    def sample_emitter_direction(self: mitsuba.cuda_ad_rgb.Scene, ref, sample: mitsuba.cuda_ad_rgb.Point2f, test_visibility: bool = True, active: mitsuba.Bool = True):
        """
    ...
    def sample_emitter_ray(self: mitsuba.cuda_ad_rgb.Scene, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool):
        """
    ...
    def sample_silhouette(self: mitsuba.cuda_ad_rgb.Scene, sample: mitsuba.cuda_ad_rgb.Point3f, flags: int, active: mitsuba.Bool = True):
        """
        Map a point sample in boundary sample space to a silhouette segment
    ...
    def sensors(self: mitsuba.cuda_ad_rgb.Scene) -> list:
        """
        Return the list of sensors
        """
        ...

    def sensors_dr(self: mitsuba.cuda_ad_rgb.Scene):
        """
    ...
    def silhouette_shapes(self: mitsuba.cuda_ad_rgb.Scene) -> list:
        """
...
class SensorPtr:
    ...
    def eval(self: mitsuba.cuda_ad_rgb.SensorPtr, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.cuda_ad_rgb.SensorPtr, it: mitsuba.cuda_ad_rgb.Interaction3f, ds: mitsuba.cuda_ad_rgb.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.SensorPtr, it: mitsuba.cuda_ad_rgb.Interaction3f, ds: mitsuba.cuda_ad_rgb.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.SensorPtr, ps: mitsuba.cuda_ad_rgb.PositionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.SensorPtr, it: mitsuba.cuda_ad_rgb.Interaction3f, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.DirectionSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.SensorPtr, time: mitsuba.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.PositionSample3f, mitsuba.Float]:
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.SensorPtr, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_ray_differential(self: mitsuba.cuda_ad_rgb.SensorPtr, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.RayDifferential3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a ray differential proportional to the sensor's
        sensitivity profile.
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.SensorPtr, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
...
class ShapePtr:
    ...
    def compute_surface_interaction(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, pi, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def differential_motion(self: mitsuba.cuda_ad_rgb.ShapePtr, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Return the attached (AD) point on the shape's surface
    ...
    def eval_attribute(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate a specific shape attribute at the given surface interaction.
    ...
    def eval_attribute_1(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, si, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Monochromatic evaluation of a shape attribute at the given surface
        interaction
    ...
    def eval_attribute_3(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Trichromatic evaluation of a shape attribute at the given surface
        interaction
    ...
    def eval_parameterization(self: mitsuba.cuda_ad_rgb.ShapePtr, uv: mitsuba.cuda_ad_rgb.Point2f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
        Parameterize the mesh using UV values
    ...
    def has_attribute(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Returns whether this shape contains the specified attribute.
    ...
    def invert_silhouette_sample(self: mitsuba.cuda_ad_rgb.ShapePtr, ss, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Map a silhouette segment to a point in boundary sample space
    ...
    def is_emitter(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.Bool:
        """
        Is this shape also an area emitter?
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.Bool:
        """
        Does the surface of this shape mark a medium transition?
        """
        ...

    def is_sensor(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.Bool:
        """
        Is this shape also an area sensor?
        """
        ...

    def pdf_direction(self: mitsuba.cuda_ad_rgb.ShapePtr, it, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Query the probability density of sample_direction()
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.ShapePtr, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Query the probability density of sample_position() for a particular
        point on the surface.
    ...
    def primitive_silhouette_projection(self: mitsuba.cuda_ad_rgb.ShapePtr, viewpoint: mitsuba.cuda_ad_rgb.Point3f, si, flags: int, sample: mitsuba.Float, active: mitsuba.Bool = True):
        """
        Projects a point on the surface of the shape to its silhouette as seen
        from a specified viewpoint.
    ...
    def ray_intersect(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
        Test for an intersection and return detailed information
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, prim_index: int = 0, active: mitsuba.Bool = True):
        """
        Fast ray intersection
    ...
    def ray_test(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Fast ray shadow test
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.ShapePtr, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
        Sample a direction towards this shape with respect to solid angles
        measured at a reference position within the scene
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.ShapePtr, time: mitsuba.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True):
        """
        Sample a point on the surface of this shape
    ...
    def sample_precomputed_silhouette(self: mitsuba.cuda_ad_rgb.ShapePtr, viewpoint: mitsuba.cuda_ad_rgb.Point3f, sample1: mitsuba.UInt, sample2: mitsuba.Float, active: mitsuba.Bool = True):
        """
        Samples a boundary segement on the shape's silhouette using
        precomputed information computed in precompute_silhouette.
    ...
    def sample_silhouette(self: mitsuba.cuda_ad_rgb.ShapePtr, sample: mitsuba.cuda_ad_rgb.Point3f, flags: int, active: mitsuba.Bool = True):
        """
        Map a point sample in boundary sample space to a silhouette segment
    ...
    def shape_type(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.UInt:
        """
        Returns the shape type ShapeType of this shape
        """
        ...

    def silhouette_discontinuity_types(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.UInt:
        """
        //! @{ \name Silhouette sampling routines and other utilities
        """
        ...

    def silhouette_sampling_weight(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.Float:
        """
        Return this shape's sampling weight w.r.t. all shapes in the scene
        """
        ...

    def surface_area(self: mitsuba.cuda_ad_rgb.ShapePtr) -> mitsuba.Float:
        """
        Return the shape's surface area.
...
class SilhouetteSample3f(PositionSample3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SilhouetteSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SilhouetteSample3f, other: mitsuba.cuda_ad_rgb.SilhouetteSample3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_ad_rgb.SilhouetteSample3f, arg0: mitsuba.cuda_ad_rgb.SilhouetteSample3f) -> None: ...
    def is_valid(self: mitsuba.cuda_ad_rgb.SilhouetteSample3f) -> mitsuba.Bool:
        """
        Is the current boundary segment valid=
        """
        ...

    def spawn_ray(self: mitsuba.cuda_ad_rgb.SilhouetteSample3f) -> mitsuba.cuda_ad_rgb.Ray3f:
        """
...
class SurfaceInteraction3f(Interaction3f):
    ...
    def emitter(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, scene: mitsuba.cuda_ad_rgb.Scene, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.EmitterPtr:
        """
    ...
    def is_medium_transition(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> mitsuba.Bool:
        """
        Does the surface mark a transition between two media?
        """
        ...

    def is_sensor(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> mitsuba.Bool:
        """
    ...
    @overload
    def target_medium(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, cos_theta: mitsuba.Float) -> mitsuba.cuda_ad_rgb.MediumPtr:
        """
...
class TensorXb:
    ...
    @overload
    def __init__(self: mitsuba.TensorXb, array: mitsuba.Bool) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXb, array: mitsuba.Bool, shape: List[int]) -> None: ...
    @overload
...
class TensorXf64:
    ...
    @overload
    def __init__(self: mitsuba.TensorXf64, array: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXf64, array: mitsuba.Float64, shape: List[int]) -> None: ...
    @overload
...
class TensorXf:
    ...
    @overload
    def __init__(self: mitsuba.TensorXf, array: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXf, array: mitsuba.Float, shape: List[int]) -> None: ...
    @overload
...
class TensorXi:
    ...
    @overload
    def __init__(self: mitsuba.TensorXi, array: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXi, array: mitsuba.Int, shape: List[int]) -> None: ...
    @overload
...
class TensorXi64:
    ...
    @overload
    def __init__(self: mitsuba.TensorXi64, array: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXi64, array: mitsuba.Int64, shape: List[int]) -> None: ...
    @overload
...
class TensorXu:
    ...
    @overload
    def __init__(self: mitsuba.TensorXu, array: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXu, array: mitsuba.UInt, shape: List[int]) -> None: ...
    @overload
...
class TensorXu64:
    ...
    @overload
    def __init__(self: mitsuba.TensorXu64, array: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.TensorXu64, array: mitsuba.UInt64, shape: List[int]) -> None: ...
    @overload
...
class Texture(Object):
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_1(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_1_grad(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
    ...
    def eval_3(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def mean(self: mitsuba.cuda_ad_rgb.Texture) -> mitsuba.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.Texture, p: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Returns the probability per unit area of sample_position()
        """
        ...

    def pdf_spectrum(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color0f:
        """
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.Texture, sample: mitsuba.cuda_ad_rgb.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, mitsuba.Float]:
        """
    ...
    def sample_spectrum(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample: mitsuba.cuda_ad_rgb.Color0f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
...
class Texture1f64:
    @overload
    def __init__(self: mitsuba.Texture1f64, shape: Annotated[List[int], FixedSize(1)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    def __init__(self: mitsuba.Texture1f64, tensor: mitsuba.TensorXf64, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    shape = ...

    def eval(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def eval_cubic(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True, force_drjit: bool = False) -> List[mitsuba.Float64]: ...
    def eval_cubic_grad(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float64], List[mitsuba.Array1f64]]: ...
    def eval_cubic_hessian(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True): ...
    def eval_cuda(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def eval_fetch(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(2)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(2)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(2)]: ...
    def eval_nonaccel(self: mitsuba.Texture1f64, pos: mitsuba.Array1f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def filter_mode(self: mitsuba.Texture1f64) -> drjit.FilterMode: ...
    def migrated(self: mitsuba.Texture1f64) -> bool: ...
    def set_tensor(self: mitsuba.Texture1f64, tensor: mitsuba.TensorXf64, migrate: bool = False) -> None: ...
    def set_value(self: mitsuba.Texture1f64, value: mitsuba.Float64, migrate: bool = False) -> None: ...
    def tensor(self: mitsuba.Texture1f64) -> mitsuba.TensorXf64: ...
    def use_accel(self: mitsuba.Texture1f64) -> bool: ...
    def value(self: mitsuba.Texture1f64) -> mitsuba.Float64: ...
    def wrap_mode(self: mitsuba.Texture1f64) -> drjit.WrapMode: ...
    ...

class Texture1f:
    @overload
    def __init__(self: mitsuba.Texture1f, shape: Annotated[List[int], FixedSize(1)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    def __init__(self: mitsuba.Texture1f, tensor: mitsuba.TensorXf, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    shape = ...

    def eval(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def eval_cubic(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True, force_drjit: bool = False) -> List[mitsuba.Float]: ...
    def eval_cubic_grad(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float], List[mitsuba.Array1f]]: ...
    def eval_cubic_hessian(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True): ...
    def eval_cuda(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def eval_fetch(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(2)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(2)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(2)]: ...
    def eval_nonaccel(self: mitsuba.Texture1f, pos: mitsuba.Array1f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def filter_mode(self: mitsuba.Texture1f) -> drjit.FilterMode: ...
    def migrated(self: mitsuba.Texture1f) -> bool: ...
    def set_tensor(self: mitsuba.Texture1f, tensor: mitsuba.TensorXf, migrate: bool = False) -> None: ...
    def set_value(self: mitsuba.Texture1f, value: mitsuba.Float, migrate: bool = False) -> None: ...
    def tensor(self: mitsuba.Texture1f) -> mitsuba.TensorXf: ...
    def use_accel(self: mitsuba.Texture1f) -> bool: ...
    def value(self: mitsuba.Texture1f) -> mitsuba.Float: ...
    def wrap_mode(self: mitsuba.Texture1f) -> drjit.WrapMode: ...
    ...

class Texture2f64:
    @overload
    def __init__(self: mitsuba.Texture2f64, shape: Annotated[List[int], FixedSize(2)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    def __init__(self: mitsuba.Texture2f64, tensor: mitsuba.TensorXf64, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    shape = ...

    def eval(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def eval_cubic(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True, force_drjit: bool = False) -> List[mitsuba.Float64]: ...
    def eval_cubic_grad(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float64], List[mitsuba.Array2f64]]: ...
    def eval_cubic_hessian(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float64], List[mitsuba.Array2f64], List[mitsuba.Matrix2f64]]: ...
    def eval_cuda(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def eval_fetch(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(4)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(4)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(4)]: ...
    def eval_nonaccel(self: mitsuba.Texture2f64, pos: mitsuba.Array2f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def filter_mode(self: mitsuba.Texture2f64) -> drjit.FilterMode: ...
    def migrated(self: mitsuba.Texture2f64) -> bool: ...
    def set_tensor(self: mitsuba.Texture2f64, tensor: mitsuba.TensorXf64, migrate: bool = False) -> None: ...
    def set_value(self: mitsuba.Texture2f64, value: mitsuba.Float64, migrate: bool = False) -> None: ...
    def tensor(self: mitsuba.Texture2f64) -> mitsuba.TensorXf64: ...
    def use_accel(self: mitsuba.Texture2f64) -> bool: ...
    def value(self: mitsuba.Texture2f64) -> mitsuba.Float64: ...
    def wrap_mode(self: mitsuba.Texture2f64) -> drjit.WrapMode: ...
    ...

class Texture2f:
    @overload
    def __init__(self: mitsuba.Texture2f, shape: Annotated[List[int], FixedSize(2)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    def __init__(self: mitsuba.Texture2f, tensor: mitsuba.TensorXf, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    shape = ...

    def eval(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def eval_cubic(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True, force_drjit: bool = False) -> List[mitsuba.Float]: ...
    def eval_cubic_grad(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float], List[mitsuba.Array2f]]: ...
    def eval_cubic_hessian(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float], List[mitsuba.Array2f], List[mitsuba.Matrix2f]]: ...
    def eval_cuda(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def eval_fetch(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(4)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(4)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(4)]: ...
    def eval_nonaccel(self: mitsuba.Texture2f, pos: mitsuba.Array2f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def filter_mode(self: mitsuba.Texture2f) -> drjit.FilterMode: ...
    def migrated(self: mitsuba.Texture2f) -> bool: ...
    def set_tensor(self: mitsuba.Texture2f, tensor: mitsuba.TensorXf, migrate: bool = False) -> None: ...
    def set_value(self: mitsuba.Texture2f, value: mitsuba.Float, migrate: bool = False) -> None: ...
    def tensor(self: mitsuba.Texture2f) -> mitsuba.TensorXf: ...
    def use_accel(self: mitsuba.Texture2f) -> bool: ...
    def value(self: mitsuba.Texture2f) -> mitsuba.Float: ...
    def wrap_mode(self: mitsuba.Texture2f) -> drjit.WrapMode: ...
    ...

class Texture3f64:
    @overload
    def __init__(self: mitsuba.Texture3f64, shape: Annotated[List[int], FixedSize(3)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    def __init__(self: mitsuba.Texture3f64, tensor: mitsuba.TensorXf64, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    shape = ...

    def eval(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def eval_cubic(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True, force_drjit: bool = False) -> List[mitsuba.Float64]: ...
    def eval_cubic_grad(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float64], List[mitsuba.Array3f64]]: ...
    def eval_cubic_hessian(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float64], List[mitsuba.Array3f64], List[mitsuba.Matrix3f64]]: ...
    def eval_cuda(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def eval_fetch(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(8)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(8)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float64]], FixedSize(8)]: ...
    def eval_nonaccel(self: mitsuba.Texture3f64, pos: mitsuba.Array3f64, active: mitsuba.Bool = True) -> List[mitsuba.Float64]: ...
    def filter_mode(self: mitsuba.Texture3f64) -> drjit.FilterMode: ...
    def migrated(self: mitsuba.Texture3f64) -> bool: ...
    def set_tensor(self: mitsuba.Texture3f64, tensor: mitsuba.TensorXf64, migrate: bool = False) -> None: ...
    def set_value(self: mitsuba.Texture3f64, value: mitsuba.Float64, migrate: bool = False) -> None: ...
    def tensor(self: mitsuba.Texture3f64) -> mitsuba.TensorXf64: ...
    def use_accel(self: mitsuba.Texture3f64) -> bool: ...
    def value(self: mitsuba.Texture3f64) -> mitsuba.Float64: ...
    def wrap_mode(self: mitsuba.Texture3f64) -> drjit.WrapMode: ...
    ...

class Texture3f:
    @overload
    def __init__(self: mitsuba.Texture3f, shape: Annotated[List[int], FixedSize(3)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    def __init__(self: mitsuba.Texture3f, tensor: mitsuba.TensorXf, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    shape = ...

    def eval(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def eval_cubic(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True, force_drjit: bool = False) -> List[mitsuba.Float]: ...
    def eval_cubic_grad(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float], List[mitsuba.Array3f]]: ...
    def eval_cubic_hessian(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> Tuple[List[mitsuba.Float], List[mitsuba.Array3f], List[mitsuba.Matrix3f]]: ...
    def eval_cuda(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def eval_fetch(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(8)]: ...
    def eval_fetch_cuda(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(8)]: ...
    def eval_fetch_drjit(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> Annotated[List[List[mitsuba.Float]], FixedSize(8)]: ...
    def eval_nonaccel(self: mitsuba.Texture3f, pos: mitsuba.Array3f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def filter_mode(self: mitsuba.Texture3f) -> drjit.FilterMode: ...
    def migrated(self: mitsuba.Texture3f) -> bool: ...
    def set_tensor(self: mitsuba.Texture3f, tensor: mitsuba.TensorXf, migrate: bool = False) -> None: ...
    def set_value(self: mitsuba.Texture3f, value: mitsuba.Float, migrate: bool = False) -> None: ...
    def tensor(self: mitsuba.Texture3f) -> mitsuba.TensorXf: ...
    def use_accel(self: mitsuba.Texture3f) -> bool: ...
    def value(self: mitsuba.Texture3f) -> mitsuba.Float: ...
...
class Transform3d:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: mitsuba.Matrix3f64) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: mitsuba.Matrix3f64, arg1: mitsuba.Matrix3f64) -> None:
        """
        Initialize from a matrix and its inverse transpose
...
class Transform3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: mitsuba.Matrix3f) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: mitsuba.Matrix3f, arg1: mitsuba.Matrix3f) -> None:
        """
        Initialize from a matrix and its inverse transpose
...
class Transform4d:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: mitsuba.Matrix4f64) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: mitsuba.Matrix4f64, arg1: mitsuba.Matrix4f64) -> None:
        """
        Initialize from a matrix and its inverse transpose
...
class Transform4f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: mitsuba.Matrix4f) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: mitsuba.Matrix4f, arg1: mitsuba.Matrix4f) -> None:
        """
        Initialize from a matrix and its inverse transpose
...
class UInt:
    @overload
    def __init__(self: mitsuba.UInt, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.UInt, arg0: mitsuba.UInt) -> None: ...
    ...

class UInt64:
    @overload
    def __init__(self: mitsuba.UInt64, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: int) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.Int) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.UInt) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.Int64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.Float) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.Float64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0: mitsuba.UInt64) -> None: ...
    @overload
    def __init__(self: mitsuba.UInt64, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...

    def assign(self: mitsuba.UInt64, arg0: mitsuba.UInt64) -> None: ...
    ...
...
class Volume(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Volume, props: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_1(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate this volume as a single-channel quantity.
        """
        ...

    def eval_3(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
    ...
    def eval_6(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: mitsuba.Bool = True) -> Annotated[List[mitsuba.Float], FixedSize(6)]:
        """
    ...
    def eval_gradient(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Vector3f]:
        """
    ...
    def eval_n(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: mitsuba.Bool = True) -> List[mitsuba.Float]:
        """
...
from . import python_ad as ad


from . import python_chi2 as chi2

def cie1931_xyz(wavelength: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Color3f:
    """
...
def cie1931_y(wavelength: mitsuba.Float) -> mitsuba.Float:
    """
...
def cie_d65(wavelength: mitsuba.Float) -> mitsuba.Float:
    """
...
def eval_reflectance(type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, wi: mitsuba.cuda_ad_rgb.Vector3f, eta: float) -> mitsuba.Float: ...
...
errors defaults to 'strict'.
"""
def fresnel(cos_theta_i: mitsuba.Float, eta: mitsuba.Float) -> Tuple[mitsuba.Float, mitsuba.Float, mitsuba.Float, mitsuba.Float]:
    """
...
def fresnel_conductor(cos_theta_i: mitsuba.Float, eta: mitsuba.Complex2f) -> mitsuba.Float:
    """
    Calculates the unpolarized Fresnel reflection coefficient at a planar
...
def fresnel_diffuse_reflectance(eta: mitsuba.Float) -> mitsuba.Float:
    """
...
def fresnel_polarized(cos_theta_i: mitsuba.Float, eta: mitsuba.Complex2f) -> Tuple[mitsuba.Complex2f, mitsuba.Complex2f, mitsuba.Float, mitsuba.Complex2f, mitsuba.Complex2f]:
    """
...
@overload
def has_flag(arg0: mitsuba.UInt, arg1: mitsuba.EmitterFlags) -> mitsuba.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.RayFlags) -> bool: ...
@overload
def has_flag(arg0: mitsuba.UInt, arg1: mitsuba.RayFlags) -> mitsuba.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.DiscontinuityFlags) -> bool: ...
@overload
def has_flag(arg0: mitsuba.UInt, arg1: mitsuba.DiscontinuityFlags) -> mitsuba.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.BSDFFlags) -> bool: ...
@overload
def has_flag(arg0: mitsuba.UInt, arg1: mitsuba.BSDFFlags) -> mitsuba.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.FilmFlags) -> bool: ...
@overload
def has_flag(arg0: mitsuba.UInt, arg1: mitsuba.FilmFlags) -> mitsuba.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.PhaseFunctionFlags) -> bool: ...
@overload
def has_flag(arg0: mitsuba.UInt, arg1: mitsuba.PhaseFunctionFlags) -> mitsuba.Bool: ...
def linear_rgb_rec(wavelength: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Color3f:
    """
...
@overload
def luminance(value: mitsuba.cuda_ad_rgb.Color3f, wavelengths: mitsuba.cuda_ad_rgb.Color0f, active: mitsuba.Bool = True) -> mitsuba.Float: ...
@overload
def luminance(c: mitsuba.cuda_ad_rgb.Color3f) -> mitsuba.Float: ...

from . import python_math as math


from . import cuda_ad_rgb_mueller as mueller
...
@overload
def pdf_rgb_spectrum(wavelengths: mitsuba.Float) -> mitsuba.Float:
    """
...
def permute(value: mitsuba.UInt, size: int, seed: mitsuba.UInt, rounds: int = 4) -> mitsuba.UInt:
    """
...
def permute_kensler(i: mitsuba.UInt, l: int, p: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.UInt:
    """
...
def perspective_projection(film_size: mitsuba.Vector2i, crop_size: mitsuba.Vector2i, crop_offset: mitsuba.Vector2i, fov_x: mitsuba.Float, near_clip: mitsuba.Float, far_clip: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Transform4f:
    """
...
from . import cuda_ad_rgb_quad as quad

def radical_inverse_2(index: mitsuba.UInt, scramble: mitsuba.UInt) -> mitsuba.Float:
    """
...
@overload
def refract(wi: mitsuba.cuda_ad_rgb.Vector3f, cos_theta_t: mitsuba.Float, eta_ti: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
@overload
def refract(wi: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Normal3f, cos_theta_t: mitsuba.Float, eta_ti: mitsuba.Float) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
@overload
def sample_rgb_spectrum(sample: mitsuba.Float) -> Tuple[mitsuba.Float, mitsuba.Float]:
    """
...
@overload
def sample_tea_32(v0: mitsuba.UInt, v1: mitsuba.UInt, rounds: int = 4) -> Tuple[mitsuba.UInt, mitsuba.UInt]:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
@overload
def sample_tea_64(v0: mitsuba.UInt, v1: mitsuba.UInt, rounds: int = 4) -> mitsuba.UInt64:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
@overload
def sample_tea_float64(v0: mitsuba.UInt, v1: mitsuba.UInt, rounds: int = 4) -> mitsuba.Float64:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
@overload
def sample_tea_float32(v0: mitsuba.UInt, v1: mitsuba.UInt, rounds: int = 4) -> mitsuba.Float:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
def sggx_pdf(wm: mitsuba.cuda_ad_rgb.Vector3f, s) -> mitsuba.Float:
    """
...
def sggx_projected_area(wi: mitsuba.cuda_ad_rgb.Vector3f, s) -> mitsuba.Float:
    """
...
@overload
def sggx_sample(sh_frame: mitsuba.cuda_ad_rgb.Frame3f, sample: mitsuba.cuda_ad_rgb.Point2f, s) -> mitsuba.cuda_ad_rgb.Normal3f:
    """
...
@overload
def sggx_sample(sh_frame: mitsuba.cuda_ad_rgb.Vector3f, sample: mitsuba.cuda_ad_rgb.Point2f, s) -> mitsuba.cuda_ad_rgb.Normal3f:
    """
    Samples the visible normal distribution of the SGGX microflake
    distribution
...
def sobol_2(index: mitsuba.UInt, scramble: mitsuba.UInt) -> mitsuba.Float:
    """
...
from . import cuda_ad_rgb_spline as spline

def srgb_model_eval(arg0: mitsuba.Array3f, arg1: mitsuba.cuda_ad_rgb.Color0f) -> mitsuba.cuda_ad_rgb.Color3f: ...
...
def srgb_model_mean(arg0: mitsuba.Array3f) -> mitsuba.Float: ...
def srgb_to_xyz(rgb: mitsuba.cuda_ad_rgb.Color3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
    """
...
from . import cuda_ad_rgb_warp as warp


from . import python_xml as xml
...
def xyz_to_srgb(rgb: mitsuba.cuda_ad_rgb.Color3f, active: mitsuba.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
    """
